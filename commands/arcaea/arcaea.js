    ...
    if (!arg[0]) {
      ...
      let embed = new MessageEmbed()
         ...
         .setAuthor("Arcaea | Recent")
          .setTitle(
            title.artist +" - "+ title.title_localized.en
          )
          .addField("Chart Info:", 
...
**Collection/Recollection Gauge**: ${score.health}%`
        ...
        if(result.is_char_uncapped === true) embed.setFooter(
...
Notes: ${result.difficulties.totalNotes}`
        ...
        if(b30.userInfo.is_char_uncapped=== true) {
          embeds[0]
...
**Collection/Recollection Gauge**: ${score.health}%`
          ...
          if(result.is_char_uncapped=== true)
          embed.setFooter(
            `Played by ${result.name}`,
            `https://cdn.glitch.com/a807634f-7022-4168-b42a-f2974966221b%2F${result.character}u_icon.png`
          );
