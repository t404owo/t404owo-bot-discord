   ...
   const type = args[0];
    if (type === "on" || type === "enable") {
      ...
      message.noMentionReply(
        `${process.env.EMOTE_OK || '<:hikariok:801419553841741904>'} | Leave/Goodbye message is successfully enabled!`
      );
      return;
    }
    if (type === "off" || type === "disable") {
      ...
      message.noMentionReply(
        `${process.env.EMOTE_OK || '<:hikariok:801419553841741904>'} | Leave/Goodbye message is successfully disabled!`
      );
      return;
