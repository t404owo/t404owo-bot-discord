...
exports.run = (bot, message, args) => {
      ...
      if (!perm.has(Permissions.FLAGS.MANAGE_GUILD)&&!perm.has(Permissions.FLAGS.MANAGE_MEMBERS)&&!bot.config.owners.includes(message.author.id)&&!perm.has(Permissions.FLAGS.ADMINISTRATOR))
      return message.mentionReply(
        `${process.env.EMOTE_NO || '<:tairitsuno:801419553933492245>'}`+" | You can't use that command! you need at least manage server, manage members or admin perm!"
      );
